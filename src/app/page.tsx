    ...
    <div className="min-h-screen pb-24 bg-[#0F0F0F] text-white overflow-x-hidden">
      ...
      {isAnimating && (
        <div className="fixed inset-0 z-[10000] bg-black flex flex-col items-center justify-center">
          ...
          <p className="mt-8 text-cyan-300 text-[10px] tracking-[0.5em] uppercase font-bold">Broadcasting Live...</p>
        </div>
      )}

      {/* २. STN Channel - डेस्कटपका लागि साच्चिकै फुल स्क्रिन (कार्डहरू भन्दा अगाडि) */}
        ...
        <div className="flex justify-between items-center mb-2">
          ...
          {session && (
            <div className="flex items-center gap-3 bg-white/5 p-1 pr-3 rounded-full border border-white/10">
              ...
              <button onClick={() => signOut()} className="text-[10px] font-bold text-red-400 uppercase">Logout</button>
            </div>
          )}
        </div>
      ...
      {/* ४. Services Grid */}
      <div className="p-4">
        <h2 className="font-bold text-lg mb-4 text-white uppercase tracking-tighter flex items-center gap-2 px-1">
